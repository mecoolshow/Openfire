...
public class SASLAuthentication {
    ...
    public static String getSASLMechanisms(LocalSession session) {
        ...
        if (session instanceof IncomingServerSession) {
            ...
            if (session.isSecure()) {
                ...
                sb.append("<mechanism>BBB</mechanism>");
            }
        }
        else {
        ...
        if (doc.getNamespace().asXML().equals(SASL_NAMESPACE)) {
            ...
            switch (type) {
                case AUTH:
                    ...
                    else if (mechanism.equalsIgnoreCase("BBB")) {
                        status = doBBBAuthentication(session, doc);
                    }
    ...
    private static Status doBBBAuthentication(LocalSession session, Element doc)
